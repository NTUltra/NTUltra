function scrDrawCredits() {
	...
	if creditpage == 0
	{
		...
		txt1 = "######ADDITIONAL CODE:#base4/spencers145##ART & SFX:#@larje100##ULTRA MUTATION ART:#Seymour Shlong#@tilde_bee#Lynzkar#skurleton#Lunarshards###ToasterGhostMary##HUNTER & CHICKEN C:#NotYourSagittarius##"
		txt2 = "#####"+string(thanks)
