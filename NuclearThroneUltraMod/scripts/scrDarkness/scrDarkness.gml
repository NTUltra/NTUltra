function scrDarkness() {
	...
	with TopDecalLight
	draw_circle(x-__view_get( e__VW.XView, 0 )+(16*image_xscale),y-__view_get( e__VW.YView, 0 )+16,48,0)
	with Bones
	...
	with ThePit
	draw_circle(x-__view_get( e__VW.XView, 0 ),y-__view_get( e__VW.YView, 0 ),132+random(8),0)
	//Top enemies
	with SquareBat
