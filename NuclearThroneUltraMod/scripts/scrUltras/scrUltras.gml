...
*/
	...
	if altOverride || (instance_exists(Player) &&  Player.race == 9 && (Player.altUltra))
	{
		...
		ultra_text[33] = "CAN NO LONGER BECOME <w>HEADLESS<w> INSTEAD#WHILE YOU ARE ABOVE <g>LEVEL<g> <w>2<w>#<aq>PREVENT<aq> <w>DEATH<w>#LOSE <w>TWO LEVELS<w> AND <w>TWO RANDOM<w> <g>MUTATIONS<g>##EVERYTIME YOUR DEATH IS PREVENTED#YOU PERMANENTLY BECOME <w>STRONGER<w>#AND YOU <g>LEVEL<g> UP SLOWER#CAN ONLY <g>LEVEL<g> UP ONCE PER AREA"
	...
	ultra_tips[44] = "gunslinger"
	    ...
	    ultra_name[48] = "LAG"
	    ultra_text[48] = "FIRST <w>TWO<w> HITS#YOU TAKE IN A LEVEL WILL BE <aq>NEGLECTED<aq>"
	...
	*/
	...
	ultra_tips[60] = "phase"
		...
		if altOverride || (instance_exists(Player) &&  Player.race == 16 && (Player.altUltra))
		{
			...
			ultra_text[61] = "<p>KRAKEN<p> WEAPONS DEAL MORE DAMAGE#AND REFUND <w>25%<w> <y>AMMO<y>#<p>TENTACLES<p> ARE LONGER AND <g>VENOMOUS<g>##<p>TENTACLE<p> <gb>ARMOUR<gb> <w>STRIKE<w>#WHENEVER YOU LOSE <gb>ARMOUR<gb>#SPAWN A <pi>TINY<pi> <p>KRAKEN<p>"//TENTACLES DESTROY ALL ENEMY PROJECTILES <-- nope
	...
	*/
	...
	ultra_text[114] = "WHEN YOU <r>KILL<r> AN <r>ENEMY<r>#<w>ALL<w> <r>ENEMIES<r> OF THAT <w>TYPE<w>#WILL BE SENT TO THE <w>NEXT AREA<w>##THE ENEMY TYPE SENT OVER#CANNOT CROSS OVER AGAIN#DOES NOT WORK ON BOSSES#SENT OVER ENEMIES LOSE <w>25%<w> <r>HEALTH<r>"
