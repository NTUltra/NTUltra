...
*/
	...
	if altOverride || (instance_exists(Player) &&  Player.race == 5 && (Player.altUltra || Player.unlockAlternativeUltras || (instance_exists(UltraIcon) && (scrIsCrown(7) || scrIsCrown(28) || scrIsGamemode(39)))))
	{
		...
		ultra_text[19] = "YOUR ACTIVE CHANGES INTO <w>KILL KILL KILL<w>:#TARGET ONE ENEMY#DEAL AN <r>ABSURD<r> AMOUNT OF <r>DAMAGE<r> TO IT#AND ANY OF ITS <w>TYPE<w>#IF YOU HAVE <p>THRONEBUTT<p> ALSO <r>HEAL<r> 2 <r>HP<r>#CAN BE DONE TWICE PER AREA"
