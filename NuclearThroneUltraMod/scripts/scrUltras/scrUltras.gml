...
*/
	...
	ultra_text[19] = "REPLACE SNARE WITH SPRINT#KILLING ENEMIES HAS A CHANCE#TO MAKE YOU IMMUNE FOR A SHORT DURATION#MOVING FASTER#INCREASES THE CHANCE#EFFECT CAN STACK WITH MULTIPLE KILLS#THRONEBUTT INCREASES THE DURATION"
	ultra_tips[19] = "nutritious"
	...
	ultra_tips[52] = "cannibalism"//morph gun creates two sheep cause logic (no balance)
	    ...
	    ultra_text[53] = "THROWS PIERCE AND DEFLECT PROJECTILES#MORE THROW DAMAGE#THROWS BOUNCE TOWARDS ENEMIES#THROWS BOUNCE TOWARDS ENEMIES"
