function scrSecretUltraStat() {
	...
	secret_ultra_text[9] = "WHILE YOU ARE ABOVE <g>LEVEL<g> 1#PREVENT THE LOSS OF YOUR HEAD#INSTEAD, REGAIN ALL YOUR <r>HP<r>#LOSE A LEVEL AND A RANDOM <g>MUTATION<g>##EVERYTIME YOUR DEATH IS PREVENTED#YOU PERMANENTLY BECOME <w>STRONGER<w>#AND YOU <g>LEVEL<g> UP SLOWER"
	...
	secret_ultra_text[11] = "+40 MAX <r>HP<r>!#YOU CAN'T <r>HEAL<r>#EVERY LOOP RESET HP TO FULL#ALLIES COST <y>AMMO<y>"
	...
	secret_ultra_text[12] = "REPLACE YOUR ACTIVE WITH A <w>SNIPER EYE<w>#THE EYE BREAKS <w>WALLS<w>#<w>PIERCES<w>, <w>STUNS<w> AND <w>DAMAGES<w> ENEMIES#DAMAGE INCREASES EACH PIERCE#MORE POWERFUL#THE LONGER YOU WAIT BETWEEN SHOTS#POWER SCALES FASTER#IF YOU HAVE THRONE BUTT##<w>FULLY CHARGED<w> EYE#<w>DESTROYS<w> ENEMY PROJECTILES"
	...
	secret_ultra_text[16] = "ALL WEAPONS ARE <w>FULLY AUTOMATIC<w>#YOU NO LONGER THROW WEAPONS#INSTEAD YOUR ACTIVE FIRES YOUR WEAPON#FROM THE ORIGIN OF YOUR <w>CROSSHAIR<w>";
	...
	secret_ultra_text[19] = "REPLACE ALL YOUR <r>HEALTH<r> WITH <gb>ARMOUR<gb>##<r>HEALTH<r> DROPS BECOME <gb>ARMOUR<gb> DROPS##(SECOND STOMACH DOUBLES ARMOUR#FROM ARMOUR DROPS)#(HEALING MUTATIONS DO NOT#REGENERATE ARMOUR)"
	...
	secret_ultra_text[31] = "<r>FIERY<r> HANDS#MORE <r>FIRE<r> DAMAGE#HOMING <r>FIRE<r>#EVEN MORE <r>FIRE<r> DAMAGE#WHILE IN <w>INVERTED AREAS<w>#<w>INVERTED PORTALS<w>#(OVER) <r>HEAL YOU FOR 5 <r>HP<r>"
	...
	secret_ultra_text[32] = "<w>EXPLOSIVE<w> HANDS#HAND IS SLOWER#NORMAL HAND SPEED IN <w>INVERTED AREAS<w>#<w>INVERTED PORTALS<w>#(OVER) <r>HEAL<r> YOU FOR 5 <r>HP<r>"
