function scrSecretUltraStat() {
	...
	secret_ultra_text[12] = "REPLACE YOUR ACTIVE WITH A <w>SNIPER EYE<w>#THE EYE STUNS AND BREAKS <w>WALLS<w>#DAMAGE INCREASES EACH PIERCE#POWER SLOWLY SCALES#POWER SCALES FASTER#IF YOU HAVE THRONE BUTT##<w>FULLY CHARGED<w> EYE#<w>DESTROYS<w> ENEMY PROJECTILES"
	secret_ultra_tips[12] = "proper eyesight"
	secret_ultra_hint[12] = "MIND'S EYE";
	secret_ultra_unlk[12] = "HAVE TWO OF THESE\nENERGY BRAIN, EAGLE EYES, OPEN MIND\nOR CROWN OF BLNIDNESS";
	...
	secret_ultra_text[19] = "REPLACE ALL YOUR <r>HEALTH<r> WITH <gb>MAX ARMOUR<gb>##<r>HEALTH<r> DROPS BECOME <gb>ARMOUR<gb> DROPS##(SECOND STOMACH DOUBLES ARMOUR#FROM ARMOUR DROPS)#(HEALING MUTATIONS DO NOT#REGENERATE ARMOUR)"
	...
	secret_ultra_text[31] = "<r>FIERY<r> HANDS#MORE <r>FIRE<r> DAMAGE#HOMING <r>FIRE<r>#EVEN MORE <r>FIRE<r> DAMAGE#WHILE IN <w>INVERTED AREAS<w>#<w>INVERTED PORTALS<w>#(OVER) <r>HEAL YOU FOR 4 <r>HP<r>"
	...
	secret_ultra_text[32] = "<w>EXPLOSIVE<w> HANDS#HAND IS SLOWER#NORMAL HAND SPEED IN <w>INVERTED AREAS<w>#<w>INVERTED PORTALS<w>#(OVER) <r>HEAL<r> YOU FOR 4 <r>HP<r>"
	...
	secret_ultra_text[33] = "YOUR ACTIVE CHANGES INTO#<w>KILL KILL KILL<w>:#TARGET ONE ENEMY#DEAL AN <r>ABSURD<r> AMOUNT OF <r>DAMAGE<r> TO IT#AND ANY OF ITS <w>TYPE<w>#IF YOU HAVE <p>THRONEBUTT<p> ALSO <r>HEAL<r> 2 <r>HP<r>#CAN BE DONE TWICE PER AREA"
	...
	secret_ultra_hint[34] = "VOID GUTS";
