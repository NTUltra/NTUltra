function scrSecretUltraStat() {
	...
	secret_ultra_text[9] = "CAN NO LONGER BECOME <w>HEADLESS<w> INSTEAD#WHILE YOU ARE ABOVE <g>LEVEL<g> 1#<aq>PREVENT<aq> <w>DEATH<w>#LOSE A LEVEL AND A RANDOM <g>MUTATION<g>##EVERYTIME YOUR DEATH IS PREVENTED#YOU PERMANENTLY BECOME <w>STRONGER<w>#AND YOU <g>LEVEL<g> UP SLOWER#CAN ONLY <g>LEVEL<g> UP ONCE PER AREA"
	...
	secret_ultra_text[25] = "GO TO YV'S CRIB#YOUR SHOP BECOMES A <w>WEAPON WHEEL<w>#SELECT A SLOT TO STORE WEAPONS#THRONE BUTT DOUBLES INVENTORY SIZE##AT THE START OF EACH LOOP#<r>OVERHEAL<r> BASED ON TOTAL#WEAPON TIER#IN YOUR INVENTORY"
