function scrSecretUltraStat() {
	...
	secret_ultra_text[33] = "YYOUR ACTIVE CHANGES INTO <w>KILL KILL KILL<w>:#TARGET ONE ENEMY#DEAL AN <r>ABSURD<r> AMOUNT OF <r>DAMAGE<r> TO IT#AND ANY OF ITS <w>TYPE<w>#IF YOU HAVE <p>THRONEBUTT<p> ALSO <r>HEAL<r> 2 <r>HP<r>#CAN BE DONE TWICE PER AREA"
	...
	secret_ultra_hint[34] = "EMPTY GUTS";
