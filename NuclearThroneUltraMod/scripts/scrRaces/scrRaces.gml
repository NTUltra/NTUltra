function scrRaces() {
	...
	race_butt[21] = "BEAM CHARGES QUICKER AND <r>HEALS<r>#<w>RELEASING<w> <g>BEAM<g>#FIRES A <w>BIG BALL<w> OF <g>RADIATION<g>"
	...
	race_cskin_lock[27] = "SUCKERPUNCH#THREE IDPD VANS#INTO OBLIVION#IN A SINGLE RUN#(KILL WITH THRONE BUTT)"
		...
		*/
		...
		race_butt_detail[28] = "UPGRADE <p>STEALTH STAB<p>#LONGER <w>RANGE<w>#MORE <r>DAMAGE<r>#<w>+25%<w> OF REMAINING ENEMY HEALTH#HIGHER STEAL <w>DROP RATE<w>#STEAL MORE <y>AMMO<y>"
