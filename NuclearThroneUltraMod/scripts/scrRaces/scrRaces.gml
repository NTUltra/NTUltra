function scrRaces() {
	...
	race_name[26] = "GOOD O'L HUMPHRY"//RUSTY GRANDPA SOLDIER
	...
	if UberCont.newContent
	{
		...
		*/
		race_name[28] = "THIEF"
		race_pass[28] = "WHEN OUT OF ENEMY LINE OF SIGHT BECOME INVISIBLE"//THIEFS ARE NOT INVICIBLE TO YOU
		//YOU HAVE A SPEED BOOST WHEN INVISIBLE
		race_acti[28] = "HIDING FIELD, STAB & STEAL WHILE INVISIBLE"
		//WHEN NOT INVISIBLE THIS IS A HOLD...
		//WHEN INVISIBLE THIS IS INSTANT BUT REVEALS YOU
		race_butt[28] = "STEALTH STAB DEALS SPLASH DAMAGE#AND AN ADDITIONAL#+20% OF REMAINING ENEMY HEALTH##"
		//DONT REVEAL YOURSELF WHEN STEALING FOR THE FIRST TIME UPON ENTERING STEALTH
		race_butt_detail[28] = "STEALTH STAB DEALS AN ADDITIONAL#+20% OF REMAINING ENEMY HEALTH#AS DAMAGE"
