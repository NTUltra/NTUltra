function scrRaces() {
	...
	race_name[14] = "[PANDA]"
	race_pass[14] = "WEAPONS THROWN IN PORTAL#ARE RANDOMIZED"//"PRIMARY WEAPON IS RANDOMIZED#TO ONE OF THE SAME TIER#EACH AREA#EXCEPT YOUR STARTING WEAPON"
	...
	race_pass[24] = "STRONGER LIGHTNING,#FROST, FLAME AND KRAKEN"//I HATE THIS PASSIVE
	...
	race_pass[26] = "DEALING DAMAGE#BUILDS UP SKILL#SKILL DECREASES OVER TIME#AND WHEN YOU GET HIT#SKILL DEALS BONUS DAMAGE"//"HITTING SHOTS BUILDS SKILL#MISSING RESETS SKILL#UNTIL YOU HIT A SHOT AGAIN#SKILL INCREASES DAMAGE"
	race_acti[26] = "WARZONE CONTROL"//"SLOW AND SHRINK#ENEMY PROJECTILES#AT THE COST OF#unequipped AMMO"//DISCIPLINE those bullets
	...
	race_bskin[26] = 0
	race_cskin[26] = 0
	race_bskin_lock[26] = "TRIGGER 10 CLOSE DODGES#USING EXTRA FEET#IN ONE GAME#AS HUMPHRY"//"COMPLETE A#MAIN AREA#AFTER THE SCRAPYARD#WITHOUT MISSING#AS GOOD OL'HUMPHRY"
