function scrRaces() {
	...
	race_inpsiration[2] = "PRESS <w>[E]<w> TO: KNOCK BACK ENEMIES";
	...
	race_inpsiration[3] = "PRESS <w>[E]<w> TO: CONFUSE AN ENEMY";
	...
	race_inpsiration[4] = "PRESS <w>[E]<w> TO: MOVE CORPSES TO YOUR CROSSHAIR";
	...
	race_inpsiration[5] = "PRESS <w>[E]<w> TO: CAST A VINE#BETWEEN YOU AND YOUR <g>SNARE<g>";
	...
	race_inpsiration[0] = "PRESS <w>[E]<w> TO: INSTANTLY <w>RELOAD<w>#AND SHIFT RELOAD TIME#TO YOUR NEXT SHOT";
	...
	race_inpsiration[7] = "PRESS <w>[E]<w> TO: FIRE BOTH WEAPONS <w>ACCURATELY<w>#AT A LOWER RELOAD SPEED#WITH INCREASED <w>KNOCKBACK<w>";
	...
	race_inpsiration[8] = "PRESS <w>[E]<w> TO: ";
	...
	race_inpsiration[9] = "PRESS <w>[E]<w> TO: TOSS OF YOUR HEAD#WHILE HEADLESS GAIN 25% RELOAD SPEED#IF YOU BLEED OUT LOSE 1 MAX HP";
	...
	race_inpsiration[10] = "PRESS <w>[E]<w> TO: GRAB AN ALLY";
