function scrFire2() {
	...
	case 449:
		...
		var msk = mask_index;
		mask_index = mskBullet1;
		var aimDir = point_direction(x,y,mouse_x,mouse_y)+(random(5)-2.5)*accuracy;
		var len = 6+(accuracy*3);
		var bx = x;
		var by = y;
		var xstep = lengthdir_x(len,aimDir+90);
	...
	case 450:
		...
		var msk = mask_index;
		mask_index = mskBullet1;
		var aimDir = point_direction(x,y,mouse_x,mouse_y)+(random(7)-3.5)*accuracy;
		var len = 8+(accuracy*3);
		var xstep = lengthdir_x(len,aimDir);
		var ystep = lengthdir_y(len,aimDir);
		var bx = x;
	...
	BackCont.viewx2 += lengthdir_x(18,point_direction(x,y,mouse_x,mouse_y)+180)*UberCont.opt_shake
	BackCont.viewy2 += lengthdir_y(18,point_direction(x,y,mouse_x,mouse_y)+180)*UberCont.opt_shake
	BackCont.shake += 12
	wkick = 8
	...
	wepangle = -wepangle
	//motion_add(point_direction(x,y,mouse_x,mouse_y),6)
	BackCont.viewx2 += lengthdir_x(4,point_direction(x,y,mouse_x,mouse_y))*UberCont.opt_shake
	BackCont.viewy2 += lengthdir_y(4,point_direction(x,y,mouse_x,mouse_y))*UberCont.opt_shake
	BackCont.shake += 6
	wkick = -5
