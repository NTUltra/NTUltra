function scrFire2(hasTailNow) {
	...
	with instance_create(x+lengthdir_x(-2+(Player.skill_got[13]+bettermelee)*20,aimDirection),y+lengthdir_y(-2+(Player.skill_got[13]+bettermelee)*20,aimDirection),MorphSlash)
	{
	...
	with instance_create(x+lengthdir_x(4+(Player.skill_got[13]+bettermelee)*20,aimDirection),y+lengthdir_y(4+(Player.skill_got[13]+bettermelee)*20,aimDirection),AxeSlash)
	{
		shouldBleed = true;
	...
	with instance_create(x+lengthdir_x(4+(Player.skill_got[13]+bettermelee)*20,aimDirection),y+lengthdir_y(4+(Player.skill_got[13]+bettermelee)*20,aimDirection),GhettoBlast)
	{
	...
	with instance_create(x+lengthdir_x(4+(Player.skill_got[13]+bettermelee)*20,aimDirection),y+lengthdir_y(4+(Player.skill_got[13]+bettermelee)*20,aimDirection),RocketSlash)
	{
	image_speed=0;
	longarms = 0
	...
	*/
	...
	with instance_create(x+lengthdir_x(4+(Player.skill_got[13]+bettermelee)*20+32,aimDirection),y+lengthdir_y(4+(Player.skill_got[13]+bettermelee)*20+32,aimDirection),GhostSlash)
	{
	longarms = 0
	...
	with instance_create(x+lengthdir_x(4+(Player.skill_got[13]+bettermelee)*20,aimDirection),y+lengthdir_y(4+(Player.skill_got[13]+bettermelee)*20,aimDirection),GhostSlash)
	{
	longarms = 0
	...
	longarms = (Player.skill_got[13]+other.bettermelee)*3
	motion_add(aimDirection+50*other.accuracy,2.7+longarms)
	image_angle = direction
	team = other.team}
	with instance_create(x+lengthdir_x(4+(Player.skill_got[13]+bettermelee)*14+l,aimDirection-50*Player.accuracy),y+lengthdir_y(4+(Player.skill_got[13]+bettermelee)*14+l,aimDirection-50*Player.accuracy),GhostSlash)
	{
	...
	{
	with instance_create(x,y,Bullet1)
	{motion_add(aimDirection+(random(36)-18)*other.accuracy,15+random(6))
	image_angle = direction
	team = other.team}
	}
	...
	instance_create(x,y,Dust)
	instance_create(x,y,Smoke)
	var offset = 8 + (32 * accuracy);
	var xo1 = lengthdir_x(offset,aimDirection + 90);
	var xo2 = lengthdir_x(offset,aimDirection - 90);
	var yo1 = lengthdir_y(offset,aimDirection + 90);
	var yo2 = lengthdir_y(offset,aimDirection - 90);
...
*/
	...
	with instance_create(x + lengthdir_x(6,aimDirection),y + lengthdir_y(6,aimDirection),HeavyBullet)
	{motion_add(aimDirection,18)
	image_angle = direction
	team = other.team}
	...
	with instance_create(x+lengthdir_x(4+(Player.skill_got[13]+bettermelee)*20,aimDirection),y+lengthdir_y(4+(Player.skill_got[13]+bettermelee)*20,aimDirection),BlackSwordSlash)
	{
	longarms = 0
	...
	with instance_create(x+lengthdir_x(4+(Player.skill_got[13]+bettermelee)*19,aimDirection),y+lengthdir_y(4+(Player.skill_got[13]+bettermelee)*19,aimDirection),DarkSwordSlash)
	{
		longarms = 0
	...
	with instance_create(x+lengthdir_x(4+(Player.skill_got[13]+bettermelee)*20,aimDirection-50*Player.accuracy),y+lengthdir_y(4+(Player.skill_got[13]+bettermelee)*20,aimDirection-50*Player.accuracy),EnergySlash)
	{
		dmg = 17;
	longarms = 0
	...
	{motion_add(aimDirection+(random(28)-14)*other.accuracy,17)
	image_angle = direction
	team = other.team}
	...
	if um == ultramods.fireFrost
		toSpawn = FlameSlash;
	with instance_create(x+lengthdir_x(4+(Player.skill_got[13]+bettermelee)*20,aimDirection),y+lengthdir_y(4+(Player.skill_got[13]+bettermelee)*20,aimDirection),toSpawn)
	{
	...
	with instance_create(x+lengthdir_x(4+(Player.skill_got[13]+bettermelee)*20,aimDirection),y+lengthdir_y(4+(Player.skill_got[13]+bettermelee)*20,aimDirection),Flail)
	{
		bleedAngle = aimDirection - (30 * sign(other.wepangle));
	longarms = 0
	dmg = 17;
	...
	{motion_add(aimDirection+(random(40)-20)*other.accuracy,15+random(10))
	image_angle = direction
	team = other.team}
	}
	repeat(9)
	...
	with instance_create(x,y,Bullet3)
	{motion_add(aimDirection+(random(20)-10)*other.accuracy,7)//5.5)
	image_angle = direction
	team = other.team}
	...
	with instance_create(x+lengthdir_x(4+(Player.skill_got[13]+bettermelee)*10,aimDirection),y+lengthdir_y(4+(Player.skill_got[13]+bettermelee)*10,aimDirection),UltraShank)
	{
	longarms = 0
	...
	with instance_create(x+lengthdir_x(4+(Player.skill_got[13]+bettermelee)*20,aimDirection),y+lengthdir_y(4+(Player.skill_got[13]+bettermelee)*20,aimDirection),VanPusher)
	{
	...
	with instance_create(x+lengthdir_x(5+(Player.skill_got[13]+bettermelee)*20,aimDir),y+lengthdir_y(5+(Player.skill_got[13]+bettermelee)*20,aimDir),ExplosiveSlash)
	{
		dmg = 15
		longarms = 0
	...
	case 394:
		...
		with instance_create(x+lengthdir_x(4+(Player.skill_got[13]+bettermelee)*20,aimDirection),y+lengthdir_y(4+(Player.skill_got[13]+bettermelee)*20,aimDirection),FlameSlash)
		{
	...
	{motion_add(aimDirection+(random(28)-14)*other.accuracy,15)
	image_angle = direction
	team = other.team}
	...
	with instance_create(x+lengthdir_x(40+((Player.skill_got[13]+bettermelee)*20),aimDirection-50*Player.accuracy),y+lengthdir_y(40+((Player.skill_got[13]+bettermelee)*20),aimDirection-50*Player.accuracy),SmallSlash)
	{
		...
		longarms = 0
		longarms = (Player.skill_got[13]+other.bettermelee)*3
		motion_add(aimDirection-50*other.accuracy,3.2+longarms)
		image_angle = direction
		team = other.team
		sprite_index = sprEnergySmallSlash;
	}
	...
	with instance_create(x+lengthdir_x(4+(Player.skill_got[13]+bettermelee)*20,aimDirection),y+lengthdir_y(4+(Player.skill_got[13]+bettermelee)*20,aimDirection),UltraLollipopSlash)
	{
	...
	{motion_add(aimDirection+(random(16)-8)*other.accuracy,17+random(2))
	image_angle = direction
	team = other.team}
	...
	image_angle = direction
	team = other.team}
	with instance_create(x+lengthdir_x(4+(Player.skill_got[13]+bettermelee)*15,aimDirection+50*Player.accuracy),y+lengthdir_y(4+(Player.skill_got[13]+bettermelee)*15,aimDirection+50*Player.accuracy),EnergyHammerSlash)
	{
	dmg = 26
	sprite_index=sprVeryHeavySlash;
	longarms = 0
	...
	with instance_create(x+lengthdir_x(4+(Player.skill_got[13]+bettermelee)*20,aimDirection),y+lengthdir_y(4+(Player.skill_got[13]+bettermelee)*20,aimDirection),BigPandaSlash)
	{
		dmg = 6;
		longarms = 0
	...
	{motion_add(aimDirection,13+random(6))
	image_angle = direction
	team = other.team}
	repeat(7)
	{
	...
	{motion_add(aimDirection+((random(12)-6)-4)*other.accuracy,4+random(3))
	image_angle = direction
	team = other.team}
	with instance_create(x,y,SplitSeekerBolt)
	{motion_add(aimDirection+((random(12)-6)+4)*other.accuracy,4+random(3))
	...
	with instance_create(x+lengthdir_x(5+((Player.skill_got[13]+bettermelee)*20),aimDirection),y+lengthdir_y(5+((Player.skill_got[13]+bettermelee)*20),aimDirection),LanceShank)
	{
		sprite_index = sprShotgunLanceSlash;
	longarms = 0
	dmg = 10;
	...
	with instance_create(x+lengthdir_x(4+(Player.skill_got[13]+bettermelee)*10,aimDirection),y+lengthdir_y(4+(Player.skill_got[13]+bettermelee)*10,aimDirection),ExplosiveShank)
	{
	longarms = 0
	...
	with instance_create(x+lengthdir_x(4+(Player.skill_got[13]+bettermelee)*15,aimDirection+50*Player.accuracy),y+lengthdir_y(4+(Player.skill_got[13]+bettermelee)*15,aimDirection+50*Player.accuracy),BloodSlashRetail)
	{
		owner = other.id;
		dmg = 14
		if Player.ultra_got[16]
	...
	with instance_create(x+lengthdir_x(6+(Player.skill_got[13]+bettermelee)*20,aimDirection),y+lengthdir_y(6+(Player.skill_got[13]+bettermelee)*20,aimDirection),SpikeSlash)
	{
	dmg = 20
	longarms = 0
	...
	image_angle = direction
	team = other.team}
	with instance_create(x+lengthdir_x(6+(Player.skill_got[13]+bettermelee)*15,aimDirection+50*Player.accuracy),y+lengthdir_y(6+(Player.skill_got[13]+bettermelee)*15,aimDirection+50*Player.accuracy),SpikeSlash)
	{
	dmg = 16
	longarms = 0
	...
	case 608:
		...
		with instance_create(x+lengthdir_x(9+(Player.skill_got[13]+bettermelee)*20,aimDirection),y+lengthdir_y(9+(Player.skill_got[13]+bettermelee)*20,aimDirection),Shank)
		{
		dmg = 7
		longarms = 0
		
		longarms = (Player.skill_got[13]+other.bettermelee)*3
		motion_add(aimDirection,2.8+longarms)
		image_angle = direction
		team = other.team}
		
		with instance_create(x+lengthdir_x(7+(Player.skill_got[13]+bettermelee)*15,aimDirection+30*Player.accuracy),y+lengthdir_y(7+(Player.skill_got[13]+bettermelee)*15,aimDirection+30*Player.accuracy),Shank)
		{
		dmg = 6
		longarms = 0
		
		longarms = (Player.skill_got[13]+other.bettermelee)*3
		motion_add(aimDirection+30*other.accuracy,2.7+longarms)
		image_angle = direction
		team = other.team}
		...
		with instance_create(x+lengthdir_x(5+(Player.skill_got[13]+bettermelee)*15,aimDirection+50*Player.accuracy),y+lengthdir_y(5+(Player.skill_got[13]+bettermelee)*15,aimDirection+50*Player.accuracy),Shank)
		{
		dmg = 6
		longarms = 0
	...
	instance_create(x,y,Dust)
	var am = 20;
	with instance_create(x+lengthdir_x(4+(Player.skill_got[13]+bettermelee)*19,aimDirection),y+lengthdir_y(4+(Player.skill_got[13]+bettermelee)*19,aimDirection),FlameSlash)
	{
		sprite_index = sprMegaFireSlash;
		mask_index = mskMegaSlash;
		dmg = 26;
	...
	with instance_create(x+lengthdir_x(4+(Player.skill_got[13]+bettermelee)*20,aimDirection),y+lengthdir_y(4+(Player.skill_got[13]+bettermelee)*20,aimDirection+40*accuracy),KrakenSlash)
	{
		dmg = 18
		length += 2;
		longarms = 0
	...
	with instance_create(x+lengthdir_x(4+(Player.skill_got[13]+bettermelee)*20,aimDirection),y+lengthdir_y(4+(Player.skill_got[13]+bettermelee)*20,aimDirection-40*Player.accuracy),KrakenSlash)
	{
		dmg = 18
		length += 2;
		longarms = 0
	...
	with instance_create(x+lengthdir_x(4+(Player.skill_got[13]+bettermelee)*10,aimDirection),y+lengthdir_y(4+(Player.skill_got[13]+bettermelee)*10,aimDirection),NarrowShank)
	{
		longarms = 0
	...
	repeat(4)
	{
		with instance_create(x+lengthdir_x(l,aimDirection),y+lengthdir_y(l,aimDirection),SmallSlash)
		{
			...
			longarms = (Player.skill_got[13]+other.bettermelee)*3;
			motion_add(aimDirection,1+longarms);
			motion_add(aimDirection+oA,3+longarms)
			image_angle = direction
			team = other.team
		}
	...
	with instance_create(x+lengthdir_x(26+((Player.skill_got[13]+bettermelee)*14),aimDirection),y+lengthdir_y(26+((Player.skill_got[13]+bettermelee)*14),aimDirection),RopeSpinSlash)
	{
		longarms = 0
		longarms = (Player.skill_got[13]+other.bettermelee)*3
		motion_add(aimDirection,3+longarms)
	...
	with instance_create(x+lengthdir_x(4+(Player.skill_got[13]+bettermelee)*10,aimDirection),y+lengthdir_y(4+(Player.skill_got[13]+bettermelee)*10,aimDirection),HeavyShank)
	{
		dmg = 24;
	longarms = 0
	longarms = (Player.skill_got[13]+other.bettermelee)*3
	...
	snd_play_fire(sndMicroMicroLauncher);
	...
	with instance_create(x+lengthdir_x(4+(Player.skill_got[13]+bettermelee)*10,aimDirection),y+lengthdir_y(4+(Player.skill_got[13]+bettermelee)*10,aimDirection),FrostShank)
	{
		dmg = 10;
	longarms = 0
	longarms = (Player.skill_got[13]+other.bettermelee)*3
	...
	with instance_create(x+lengthdir_x(4+(Player.skill_got[13]+bettermelee)*20,aimDirection),y+lengthdir_y(4+(Player.skill_got[13]+bettermelee)*20,aimDirection),SlapperSlap)
	{
		longarms = 0
		dmg = 16;
		longarms = (Player.skill_got[13]+other.bettermelee)*3
	...
	with instance_create(x,y,FlakLaser)
	{image_angle = aimDirection+(random(2)-1)*other.accuracy
	team = other.team
	event_perform(ev_alarm,0)
	}
	...
	if !skill_got[2]
	{
		motion_add(aimDirection+180,0.7)
	}
	...
	case 746:
		...
		if !exists
		{
			snd_play_2d(sndSuckCannonFire,0,true);
			with instance_create(x,y,SuckCannon)
			{
				image_angle = aimDirection;
				accuracy = other.accuracy;
				owner = other.id;
	...
	with instance_create(x,y,Yoyo)
	{motion_add(aimDirection+(random(24)-12)*other.accuracy,9 + random(3))
	image_angle = direction
	team = other.team}
	...
	with instance_create(x,y,MorphBullet)
	{
		motion_add(aimDirection+(random(24)-12)*other.accuracy,20)
	image_angle = direction
	team = other.team
	}
	...
	team = other.team}
	with instance_create(x,y+4,CoffeeBullet)
	{motion_add(aimDirection+(10*other.accuracy),20)
	image_angle = direction
	team = other.team}
	with instance_create(x,y+4,CoffeeBullet)
	{motion_add(aimDirection-(10*other.accuracy),20)
	...
	team = other.team}
	with instance_create(x,y+4,CoffeeBullet)
	{motion_add(aimDirection+(20*other.accuracy),20)
	image_angle = direction
	team = other.team}
	with instance_create(x,y+4,CoffeeBullet)
	{motion_add(aimDirection-(20*other.accuracy),20)
	...
	team = other.team}
	with instance_create(x,y+4,CoffeeBullet)
	{motion_add(aimDirection+(30*other.accuracy),20)
	image_angle = direction
	team = other.team}
	with instance_create(x,y+4,CoffeeBullet)
	{motion_add(aimDirection-(30*other.accuracy),20)
	...
	snd_play_fire(sndVoidShank)
	instance_create(x,y,Dust)

	with instance_create(x+lengthdir_x(4+(Player.skill_got[13]+bettermelee)*10,aimDirection),
	y+lengthdir_y(4+(Player.skill_got[13]+bettermelee)*10,aimDirection),VoidSlash)
	{
		
		mask_index = mskVoidShank;
		sprite_index = sprVoidShank;
		longarms = 0
		dmg = 25;
		longarms = (Player.skill_got[13]+other.bettermelee)*3
		motion_add(aimDirection,2.7+longarms)
	...
	with instance_create(x+lengthdir_x(96 + (Player.skill_got[13]+bettermelee)*16,aimDirection),y+lengthdir_y(96 + (Player.skill_got[13]+bettermelee)*16,aimDirection),VoidRipperBurst)
	{
		direction = aimDirection;
		speed = 1;
	...
	with instance_create(x,y,BoltGrenade)
	{
		sticky = 0
		motion_add(aimDirection+(random(6)-3)*other.accuracy,14)
		image_angle = direction
	...
	case 755:
		...
		var aimDir = aimDirection;
		var len = 5 * accuracy;
		with instance_create(x+lengthdir_x(len,aimDir+90),y+lengthdir_y(len,aimDir+90),MorphLaser)
		{
			image_angle = aimDir+((random(2)-1) - 2) * other.accuracy
			team = other.team
			event_perform(ev_alarm,0)
		}
		with instance_create(x+lengthdir_x(len,aimDir-90),y+lengthdir_y(len,aimDir-90),MorphLaser)
		{
			image_angle = aimDir+((random(2)-1)*other.accuracy + 2) * other.accuracy
			team = other.team
			event_perform(ev_alarm,0)
		}
	...
	with instance_create(x,y,HeavyJackHammerBurst)
	{
	creator = other.id
	ammo = 5
	time = 1
	...
	with instance_create(x,y,Nail)
	{
		motion_add(aimDirection+(random(22)-11)*other.accuracy,12+random(4))
		image_angle = direction
		team = other.team
	}
	with instance_create(x,y,Nail)
	{
		motion_add(aimDirection+(random(16)-8)*other.accuracy,14+random(4))
		image_angle = direction
		team = other.team
	}
	...
	snd_play(sndPlasma);
	if Player.skill_got[17] = 1
	snd_play_fire(choose(sndPlasmaMinigunUpg,sndLaserUpg))
	else
	snd_play_fire(choose(sndPlasmaMinigun,sndLaser))
	with instance_create(x,y,PlasmaLaser)
