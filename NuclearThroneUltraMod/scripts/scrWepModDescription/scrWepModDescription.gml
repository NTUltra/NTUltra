...
function scrWepModDescription(wm){
	...
	break;
	case 14:
	return "HITS OCCASIONALLY INFUSE RADS INTO AN ENEMY"
	break;
	case 15:
	return "HITS OCCASIONALLY SPAWN THREE SPLINTERS"
	break;
	case 16:
	return "HITS OCCASIONALLY SPAWN MORPH DEALING DAMAGE\nAND IF ENEMY IS KILLED MORPHS THE ENEMY INTO A SHEEP"
	break;
	case 17:
