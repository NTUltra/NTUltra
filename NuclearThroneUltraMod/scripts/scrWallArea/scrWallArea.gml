...
function scrWallArea(area){
	...
	case 139:
	topspr=sprWall139Top;
	outspr=sprWall139Out;
	sprite_index = sprWall139Bot;
	break;

	case 140:
	topspr=sprWall140Top;
	outspr=sprWall140Out;
	sprite_index = sprWall140Bot;
	break;
	
	case 142:
	topspr=sprWall142Top;
	outspr=sprWall142Out;
	sprite_index = sprWall142Bot;
	break;
	
	case 143:
	topspr=sprWall143Top;
	outspr=sprWall143Out;
	sprite_index = sprWall143Bot;
	break;
	
	case 144:
	topspr=sprWall144Top;
	outspr=sprWall144Out;
	sprite_index = sprWall144Bot;
	break;
	
	case 145:
	topspr=sprWall145Top;
	outspr=sprWall145Out;
	sprite_index = sprWall145Bot;
	break;
	
	case 146:
	topspr=sprWall146Top;
	outspr=sprWall146Out;
	sprite_index = sprWall146Bot;
	break;
	
	case 147:
	topspr=sprWall147Top;
	outspr=sprWall147Out;
	sprite_index = sprWall147Bot;
	break;
	
	case 148:
	topspr=sprWall148Top;
	outspr=sprWall148Out;
	sprite_index = sprWall148Bot;
	break;
