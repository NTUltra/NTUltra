function scrSkills() {
	...
	skill_text[23] = "EXTRA CHESTS SPAWN#SEE CONTENTS OF WEAPON CHESTS"
	if canCheckUltra && Player.ultra_got[1]
		skill_text[23] = "EXTRA CHESTS SPAWN#SEE CONTENTS OF WEAPON CHESTS#INCREASE CONFISCATE CHANCE#BY 25%"
	...
	if isDoctor
	{
		if instance_exists(Player) && Player.skill_got[9] == 1
		{
			...
			skill_text[32] = "FIRST HIT YOU TAKE IN AN AREA#HEALS YOU INSTEAD (125%)#DOUBLE HEALING WITH SECOND STOMACH#PREVENTS LETHAL FIRST HITS"
		}
		else
		{
			//skill_text[32] = "FIRST HIT YOU TAKE IN AN AREA#WHILE BELOW MAX HP#HEALS YOU INSTEAD (125%)#PREVENTS LETHAL FIRST HITS";
			skill_text[32] = "FIRST HIT YOU TAKE IN AN AREA#HEALS YOU INSTEAD (125%)#PREVENTS LETHAL FIRST HITS";
		}
	}
	else
	{
		if instance_exists(Player) && Player.skill_got[9] == 1
		{
			...
			skill_text[32] = "FIRST HIT YOU TAKE IN AN AREA#HEALS YOU INSTEAD#DOUBLE HEALING WITH SECOND STOMACH#PREVENTS LETHAL FIRST HITS";
		}
		else
		{
			//skill_text[32] = "FIRST HIT YOU TAKE IN AN AREA#WHILE BELOW MAX HP#HEALS YOU INSTEAD#PREVENTS LETHAL FIRST HITS"
			skill_text[32] = "FIRST HIT YOU TAKE IN AN AREA#HEALS YOU INSTEAD#PREVENTS LETHAL FIRST HITS"
		}
	}
