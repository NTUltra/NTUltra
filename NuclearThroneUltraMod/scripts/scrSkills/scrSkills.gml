...
function scrSkills() {
	...
	else
	{
		...
		skill_detail[22] = "WHENEVER YOU TAKE <r>DAMAGE<r>:#<w>DEAL<w> <r>DAMAGE<r> TO ALL <w>NEARBY ENEMIES<w>#AND BRIEFLY <w>STUN<w> THEM##<w>RELOAD<w> YOUR WEAPONS#AS <r>HP<r> GETS LOWER#UP TO <w>70%<w> RELOAD SPEED#UP TO <w>35%<w> FOR OFFHAND WEAPONS#RELOAD BOOST <w>LINGERS<w>#FOR <w>3<w> SECONDS AFTER <r>HEALING<r>#ALSO GET RELOAD BOOST WHEN <r>MAX HP<r> IS <w>1<w>"//#<w>KEEP MAX REACHED RELOAD SPEED BOOST<w>#UNTIL <w>THE END OF AN AREA<w>"
	}
