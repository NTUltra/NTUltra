...
function scrSkills() {
	...
	skill_detail[8] = "<w>ENEMIES<w> TOUCHING YOU TAKE DAMAGE#VERY BRIEFLY BECOME <aq>IMMUNE<aq>#WHEN YOU <w>KILL<w> USING <g>GAMMA GUTS<g>##YOU TAKE 50% LESS <w>ENEMY CONTACT DAMAGE<w>#PREVENT <r>ENEMY<r> <g>VENOMOUS<g> CONTACT DAMAGE#ALLOWS <g>SERENE DREAMS<g> TO DEAL DAMAGE"
	if instance_exists(Player)
	{
		if Player.race == 13//Sheep
		{
			skill_detail[8] = "<pi>CHARGE<pi> DEALS MORE DAMAGE##<w>ENEMIES<w> TOUCHING YOU TAKE DAMAGE#VERY BRIEFLY BECOME <aq>IMMUNE<aq>##WHEN YOU <w>KILL<w> USING <g>GAMMA GUTS<g>#YOU TAKE 50% LESS <w>ENEMY CONTACT DAMAGE<w>#PREVENT <r>ENEMY<r> <g>VENOMOUS<g> CONTACT DAMAGE"
		}
		else if Player.race == 2//CRYSTAL
		{
			skill_detail[8] = "<w>ENEMIES<w> TOUCHING YOU OR YOUR <p>SHIELD<p>#TAKE DAMAGE#VERY BRIEFLY BECOME <aq>IMMUNE<aq>#WHEN YOU <w>KILL<w> USING <g>GAMMA GUTS<g>##YOU TAKE 50% LESS <w>ENEMY CONTACT DAMAGE<w>#PREVENT <r>ENEMY<r> <g>VENOMOUS<g> CONTACT DAMAGE"
		}
		else if Player.race == 1//FISH
		{
			skill_detail[8] = "<w>ENEMIES<w> TOUCHING YOU#TAKE DAMAGE#VERY BRIEFLY BECOME <aq>IMMUNE<aq>#WHEN YOU <w>KILL<w> USING <g>GAMMA GUTS<g>#<w>EXTENDED RANGE<w> WHEN <g>ROLLING<g>##YOU TAKE 50% LESS <w>ENEMY CONTACT DAMAGE<w>#PREVENT <r>ENEMY<r> <g>VENOMOUS<g> CONTACT DAMAGE"
		}
		else if Player.race == 18//ANGEL
		{
			skill_detail[8] = "YOUR <aq>DEFLECT<aq> DEALS MORE CONTACT DAMAGE##<w>ENEMIES<w> TOUCHING YOU TAKE DAMAGE#VERY BRIEFLY BECOME <aq>IMMUNE<aq>#WHEN YOU <w>KILL<w> USING <g>GAMMA GUTS<g>##YOU TAKE 50% LESS <w>ENEMY CONTACT DAMAGE<w>#PREVENT <r>ENEMY<r> <g>VENOMOUS<g> CONTACT DAMAGE"	
		}
	}
