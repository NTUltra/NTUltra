function scrSkills() {
	...
	if instance_exists(Player) && Player.cwep != 0
		skill_text[34] = "RELOAD YOUR OFFHAND WEAPONS#AT 15% SPEED##IF ONE OF YOUR#OFFHAND WEAPONS IS RELOADED:#INCREASE PRIMARY FIRERATE BY 30%##IF NOT:#EVERY ENEMY HAS A 10% CHANCE#TO DROP AN ADDITIONAL ITEM"
