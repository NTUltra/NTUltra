...
function scrSkills() {
	...
	*/
	...
	skill_detail[41] = "REPLACE 2 <r>HEALTH<r> WITH 1 <gb>ARMOUR<gb>#WHENEVER YOU ARE MISSING <gb>ARMOUR<gb>#REDUCE PRIMARY <w>RELOAD TIME<w>#BY 40% OF BASE RELOAD TIME#AND +10% CONSTANT RELOAD SPEED##<w>ENEMIES<w> HAVE A VERY SMALL CHANCE#TO DROP <gb>ARMOUR<gb>"
	if canCheckUltra && Player.ultra_got[62] && Player.altUltra //Living armour
	{
