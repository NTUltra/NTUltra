function scrLoadRace() {
	...
	spr_go_sit = sprMutant21CGoSit;//TODO
	spr_sit = sprMutant21CSit;//TODO
	break;
	case 22:
	...
	switch (race)
	{
		...
		spr_go_sit = sprMutant21DGoSit;//TODO
		spr_sit = sprMutant21DSit;//TODO
		break;
		case 22:
	...
	switch (race)
	{
		...
		spr_go_sit = sprMutant21EGoSit;//TODO
		spr_sit = sprMutant21ESit;//TODO
		break;
		case 22:
		spr_idle=sprMutant22DIdle;
		spr_walk=sprMutant22DWalk;
	...
	switch (race)
	{
		...
		spr_hurt=sprMutant21EHurt;
		spr_dead=sprMutant21EDead;
		spr_go_sit = sprMutant21EIdle;//TODO
		spr_sit = sprMutant21EIdle;//TODO
		break;
		case 22:
		spr_idle=sprMutant22DIdle;
		spr_walk=sprMutant22DWalk;
	...
	break;
	case 29:
	spr_idle=sprMutant29Idle;
	spr_walk=sprMutant29Walk;
	spr_hurt=sprMutant29Hurt;
	spr_dead=sprMutant29Dead;
	spr_go_sit = sprMutant29GoSit;//TODO
	spr_sit = sprMutant29Sit;//TODO
	break;
	}
	...
	snd_lowh=sndMutant29LowH;//
	snd_crwn=sndMutant29Crwn;
	snd_chst=sndMutant29Chst;//chst
	snd_wrld=sndMutant29Wrld;
	snd_thrn=sndMutant29Thrn;//
	snd_valt=sndMutant29Valt;
	snd_cpt=sndMutant29Thrn;//Captain win (unused for now)
	snd_good=[sndMutant29Thrn,sndMutant29Chst,sndMutant29Crwn];
	break;
