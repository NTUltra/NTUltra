...
with instance_create(x+lengthdir_x(60+(longarms*5),direction),y+lengthdir_y(60+(longarms*5),direction),GhostShank)
{
...
repeat(3)
{
with instance_create(x,y,direction,GhostEffect)
