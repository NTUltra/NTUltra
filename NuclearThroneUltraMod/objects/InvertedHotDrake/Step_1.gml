...
if instance_number(enemy) <= 5&&!instance_exists(GenCont) || instance_exists(SurvivalWave) || (instance_exists(Player) && point_distance(Player.x,Player.y,xstart,ystart) < 100){
	if awake==false{
		x=xstart
		y=ystart
		alarm[1]=80;
