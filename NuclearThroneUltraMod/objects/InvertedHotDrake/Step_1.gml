...
if (instance_number(enemy) <= 4 || instance_exists(SurvivalWave) || (instance_exists(Player) && point_distance(Player.x,Player.y,xstart,ystart) < 100)) && !instance_exists(GenCont) {
	if awake==false{
		x=xstart
		y=ystart
		alarm[1]=80;
