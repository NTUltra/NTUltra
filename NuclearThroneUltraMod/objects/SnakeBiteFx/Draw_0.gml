...
var waveMinus = 0.25;
var hscale = clamp(lerp(1,0,disappearTime) * flipped,0,1);
/*
...
repeat(totRepeats)
{
	var waveStrength = maxWaveStrength * lerp(1,0,j);//LERP FROM 0 to 1 to 0
	...
	var wscale = point_distance(px,py,xxs,yys)*0.5;
...
draw_sprite_ext(sprSerpentStrikeHead,imageIndex,
	xxs + lengthdir_x(1,ang - 90),
	yys + lengthdir_y(1,ang - 90),
	1,0.75,ang,c_black,1)
	draw_sprite_ext(sprSerpentStrikeHead,imageIndex,
	xxs + lengthdir_x(1,ang + 90),
	yys + lengthdir_y(1,ang + 90),
	1,0.75,ang,c_black,1)
draw_sprite_ext(sprSerpentStrikeHead,imageIndex,xxs,yys,1,0.75,ang,c_white,1);
