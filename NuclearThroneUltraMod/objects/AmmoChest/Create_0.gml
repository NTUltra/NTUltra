...
else if object_index != AmmoChestMystery && object_index != GiantGoldenAmmoChest
{
	...
	{
		if !scrIsGamemode(25) && (random(4) < 1) && !place_meeting(x,y,Player) && !(Player.area == 9 && Player.subarea == 3) && !instance_exists(SurvivalWave) && Player.area != 119 && Player.area != 120 && Player.area != 2 && Player.area != 137
		{
