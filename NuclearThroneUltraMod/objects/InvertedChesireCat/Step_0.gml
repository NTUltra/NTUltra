...
if point_distance(x,y,UberCont.mouse__x,UberCont.mouse__y)<60&&mask_index!=mskPickupThroughWall&&sprite_index!=spr_fire&&sprite_index!=sprInvertedChesireCatLaser && instance_exists(Floor)&&target>0{
