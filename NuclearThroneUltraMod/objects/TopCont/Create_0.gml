...
if instance_exists(Player)
{
	...
	else if Player.area == 115 || Player.area == 139 || Player.area == 145 || round(Player.area*0.5) = Player.area*0.5 && Player.area != 10 &&Player.area!=118 &&Player.area!=106
	...
	&&Player.area!=138 &&Player.area!=140 && Player.area != 144 && Player.area != 146
		darkness = 1
