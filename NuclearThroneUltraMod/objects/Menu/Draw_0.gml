...
if widescreen > 0
{
	if UberCont.completionpercentage >= 200
	{
...
else
{
	...
	*/
	...
	if UberCont.completionpercentage >= 200
		draw_text_color(__view_get( e__VW.XView, 0 )+6,__view_get( e__VW.YView, 0 ) - 49 + widescreen,string(UberCont.completionpercentage)+"%",c_lime,c_lime,c_lime,c_lime,1);
