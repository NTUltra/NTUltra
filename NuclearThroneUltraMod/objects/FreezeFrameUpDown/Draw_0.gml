...
if UberCont.isPaused=0
{
	...
	draw_text(x+20,y,string_hash_to_newline("FAKE LAG"))
	else if UberCont.opt_freeze == 0.1
	draw_text(x+20,y,string_hash_to_newline("FAKE STUTTER"))
} 
else if UberCont.opt_freeze=4
	draw_text(x+20,y,string_hash_to_newline("0FPS"))
else if UberCont.opt_freeze == 0.1
	draw_text(x+20,y,string_hash_to_newline("FAKE STUTTER"))
