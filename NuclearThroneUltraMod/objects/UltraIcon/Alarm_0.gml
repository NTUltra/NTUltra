...
if skill == 82 && scrIsGamemode(25)
	instance_destroy();
if skill == 0 && Player.race == 21 && (Player.unlockAlternativeUltras || (scrCheckGold(Player.wep_name[Player.wep]) || scrCheckGold(Player.wep_name[Player.bwep])))
{
	sprite_index = sprCashFlow;	
}
else if skill == 4 && Player.race == 1 && (Player.unlockAlternativeUltras || Player.bskin == 2)
{
	sprite_index = sprFishCanGun;
}
else if skill == 6 && Player.race == 2 && (Player.unlockAlternativeUltras || (Player.curse || Player.bcurse))
{
	sprite_index = sprCrystalCursedUltra;
}
else if skill == 9 && Player.race == 3 && (Player.unlockAlternativeUltras || scrHasEyesMutations())
{
...
else if Player.race == 6 && skill == 21 && (Player.unlockAlternativeUltras || scrDoesntHaveReloadMutation())
{
...
else if Player.race == 6 && skill == 24 && (Player.unlockAlternativeUltras || scrDoesntHaveDeathPrevention())
{
...
else if skill == 29 &&  Player.race == 8 && (Player.unlockAlternativeUltras || Player.spr_idle == sprMutant8DIdle)
{
...
else if skill == 51 && Player.race == 13 && (Player.unlockAlternativeUltras || !Player.skill_got[2] && !Player.skill_got[8])
{
	sprite_index = sprHynotize;
}
else if skill == 55 && Player.race == 14 && (Player.unlockAlternativeUltras || (Player.skill_got[13] || Player.skill_got[34] || Player.skill_got[20]) && !Player.skill_got[5])
{
...
else if skill == 62 &&  Player.race == 16 && (Player.unlockAlternativeUltras || (!Player.skill_got[7] && !Player.skill_got[36] && !Player.skill_got[32] && !Player.skill_got[31]))
{
	sprite_index = sprLivingArmour;
}
else if skill == 66 && Player.race == 17 && (Player.unlockAlternativeUltras || Player.bwep == 0)
{
	sprite_index = sprQuickSwapper;
}
else if skill == 68 && Player.race == 17 && (Player.unlockAlternativeUltras || scrHasMorphMod() || scrHasMorphWeapon())
{
...
else if skill == 74 && Player.race == 19 && (Player.unlockAlternativeUltras || scrHasBloodWeapon())
{
...
else if skill == 92 && Player.race == 23 && (Player.unlockAlternativeUltras || Player.wep_type[Player.wep] == 3 && Player.wep_type[Player.bwep] == 3)
{
...
else if skill == 106 && Player.race == 27 && ((Player.unlockAlternativeUltras && randomHand == 1 && !Player.bskin == 1) || Player.bskin == 1)
{
...
else if skill == 106 && Player.race == 27 && ((Player.unlockAlternativeUltras && randomHand == 2 && !Player.bskin == 2) || Player.bskin == 2)
{
